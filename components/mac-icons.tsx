/**
 * macOS-inspired icons using Lucide React.
 *
 * Rationale: Lucide is an open-source icon library (MIT license) that provides
 * clean, consistent line icons similar to Apple's SF Symbols aesthetic.
 * It's already included in the project dependencies.
 * We map file extensions to appropriate icons for a Finder-like experience.
 */
import {
  Folder,
  FolderOpen,
...
const CODE_EXTS = new Set([
  ...
  "h", "hpp", "cs", "swift", "kt", "sh", "bash", "html", "css", "scss",
  "less", "vue", "svelte", "astro", "php", "lua", "r", "zig", "dart",
  "sql", "graphql", "proto",
]);
...
// Re-export commonly used icons for toolbar/sidebar
export {
  ChevronRight,
  ChevronDown,
  Search,
